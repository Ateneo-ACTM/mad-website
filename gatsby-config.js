module.exports = {
  siteMetadata: {
    title: `Ateneo ACTM MAD Website`,
    author: `ACTM`,
    description: `The official MAD Concepts website of the Ateneo Association of Communication Technology Management`,
    siteUrl: `https://mad.ateneoactm.org/`,
  },
  plugins: [
    {
      resolve: `gatsby-plugin-manifest`,
      options: {
        name: `Ateneo ACTM MAD Website`,
        short_name: `ACTM MAD Web`,
        start_url: `/`,
